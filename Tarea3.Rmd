...
# GlobalPatterns
## Preprocesamiento 
Codigo realizado con apoyo de sitios de [internet] <https://forum.qiime2.org/t/subsetting-specific-samples-from-a-phyloseq-object/22361> <https://joey711.github.io/phyloseq/preprocess.html>
...
plot_richness(gp_subset, x = "SampleType", color = "SampleType" , measures = c("Observed", "Shannon", "Simpson" )) +
  geom_boxplot()
...
### Sitios utilizados para el código 
https://rdrr.io/bioc/phyloseq/man/subset_samples-methods.html
https://web.stanford.edu/class/bios221/labs/phyloseq/lab_phyloseq.html?utm
